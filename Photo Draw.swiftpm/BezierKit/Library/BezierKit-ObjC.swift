...
@objc public extension Path {
    ...
    @objc(selfIntersectsWithAccuracy:) func _objc_selfIntersects(accuracy: CGFloat = defaultIntersectionAccuracy) -> Bool {
        return selfIntersects(accuracy: accuracy)
    }

    @objc(intersectsPath:accuracy:) func _objc_intersects(_ other: Path, accuracy: CGFloat = defaultIntersectionAccuracy) -> Bool {
    ...
    @objc(containsPath:usingRule:accuracy:) func _objc_contains(_ other: Path, using rule: PathFillRule = .winding, accuracy: CGFloat = defaultIntersectionAccuracy) -> Bool {
...
public extension Path {
    @objc(subtractPath:accuracy:) func _objc_subtract(_ other: Path, accuracy: CGFloat=defaultIntersectionAccuracy) -> Path {
        return subtract(other, accuracy: accuracy)
    }
    @objc(unionPath:accuracy:) func `_objc_union`(_ other: Path, accuracy: CGFloat=defaultIntersectionAccuracy) -> Path {
        return union(other, accuracy: accuracy)
    }
    @objc(intersectPath:accuracy:) func _objc_intersect(_ other: Path, accuracy: CGFloat=defaultIntersectionAccuracy) -> Path {
        return intersect(other, accuracy: accuracy)
    }
    @objc(crossingsRemovedWithAccuracy:) func _objc_crossingsRemoved(accuracy: CGFloat=defaultIntersectionAccuracy) -> Path {
