...
open class PathComponent: NSObject, Reversible, Transformable {
    ...
    public func intersections(with other: PathComponent, accuracy: CGFloat = defaultIntersectionAccuracy) -> [PathComponentIntersection] {
    ...
    public func selfIntersections(accuracy: CGFloat = defaultIntersectionAccuracy) -> [PathComponentIntersection] {
        var intersections: [PathComponentIntersection] = []
        let isClosed = self.isClosed
