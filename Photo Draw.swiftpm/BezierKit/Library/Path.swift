...
open class Path: NSObject, NSSecureCoding {
    ...
    public func selfIntersects(accuracy: CGFloat = defaultIntersectionAccuracy) -> Bool {
        return !self.selfIntersections(accuracy: accuracy).isEmpty
    }

    public func selfIntersections(accuracy: CGFloat = defaultIntersectionAccuracy) -> [PathIntersection] {
    ...
    public func intersects(_ other: Path, accuracy: CGFloat = defaultIntersectionAccuracy) -> Bool {
        return !self.intersections(with: other, accuracy: accuracy).isEmpty
    }

    public func intersections(with other: Path, accuracy: CGFloat = defaultIntersectionAccuracy) -> [PathIntersection] {
    ...
    public func contains(_ other: Path, using rule: PathFillRule = .winding, accuracy: CGFloat = defaultIntersectionAccuracy) -> Bool {
