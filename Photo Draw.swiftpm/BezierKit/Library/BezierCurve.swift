...
extension BezierCurve {
    ...
    public func reduce() -> [Subcurve<Self>] {
        ...
        let step: CGFloat = reduceStepSize
        var extrema: [CGFloat] = []
    ...
    public func outlineShapes(distance d1: CGFloat, accuracy: CGFloat = defaultIntersectionAccuracy) -> [Shape] {
        return self.outlineShapes(distanceAlongNormal: d1, distanceOppositeNormal: d1, accuracy: accuracy)
    }

    public func outlineShapes(distanceAlongNormal d1: CGFloat, distanceOppositeNormal d2: CGFloat, accuracy: CGFloat = defaultIntersectionAccuracy) -> [Shape] {
